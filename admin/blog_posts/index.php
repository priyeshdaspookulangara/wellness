...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="../blog_add/" class="btn btn-sm btn-outline-primary"> <!-- Corrected link -->
                ...
                <?php foreach ($blog_posts_list as $post_item): ?>
                    <tr>
                        ...
                        <td class="action-buttons">
                            <a href="../blog_edit/?id=<?php echo $post_item['id']; ?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a> <!-- Corrected link -->
                            <a href="<?php echo SITE_URL . 'article/?slug=' . htmlspecialchars($post_item['slug']); ?>" target="_blank" class="btn btn-sm btn-success" title="View Post"><i class="fas fa-eye"></i></a> <!-- Corrected link -->
                            <a href="<?php echo SITE_URL . 'admin/blog_delete.php?id=' . $post_item['id']; ?>" class="btn btn-sm btn-danger confirm-delete" title="Delete"><i class="fas fa-trash"></i></a> <!-- blog_delete.php is in admin root -->
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
