...
$breadcrumbs = [
    ['name' => 'Blog Posts', 'link' => SITE_URL . 'admin/blog_posts/'],
    ['name' => 'Add New Post']
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $post_data['content'] = trim($_POST['content'] ?? '');
    ...
    $upload_blog_dir = __DIR__ . '/../../uploads/blog/'; // Corrected path
    ...
    if (empty($errors)) {
        // ... (SQL escape and insert logic as before) ...
        ...
        if (mysqli_num_rows($res_slug) > 0) {
            ...
            if (mysqli_query($conn, $sql_insert)) {
                ...
                header("Location: " . SITE_URL . "admin/blog_posts/"); // Corrected redirect
                exit;
            } else {
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <a href="<?php echo SITE_URL; ?>admin/blog_posts/" class="btn btn-sm btn-outline-secondary">Back to Blog Posts</a> <!-- Corrected link -->
</div>
...
<form action="<?php echo SITE_URL; ?>admin/blog_add/" method="POST" enctype="multipart/form-data"> <!-- Corrected form action -->
    <div class="row">
        <div class="col-md-9">
            <div class="card">
