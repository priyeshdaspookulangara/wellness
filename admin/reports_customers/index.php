...
$breadcrumbs = [ ['name' => 'Reports'], ['name' => 'Customers'] ];
...
<form method="GET" action="<?php echo SITE_URL; ?>admin/reports_customers/" class="form-inline mb-4"> <!-- Corrected form action -->
    <div class="form-group me-2">
        <label for="date_from_cust" class="me-1">From:</label>
        <input type="date" class="form-control" id="date_from_cust" name="date_from_cust" value="<?php echo htmlspecialchars($date_from_cust); ?>">
    </div>
    <div class="form-group me-2">
        <label for="date_to_cust" class="me-1">To:</label>
                ...
                <table class="table table-sm table-hover">
                    ...
                    <?php foreach ($top_customers_spending as $cust): ?>
                        <tr>
                            ...
                            <td><a href="<?php echo SITE_URL; ?>admin/users/user_view/?id=<?php echo $cust['id']; ?>" class="btn btn-xs btn-outline-secondary">View</a></td> <!-- Corrected link -->
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
