...
$breadcrumbs = [ ['name' => 'Reports'], ['name' => 'Sales'] ];
...
// --- Sales by Product ---
$sql_sales_by_product = "SELECT p.id as product_id, p.name as product_name, SUM(oi.quantity) as total_quantity_sold, SUM(oi.quantity * oi.price_at_purchase) as product_revenue
                         FROM order_items oi
...
// --- Sales by Category ---
$sql_sales_by_category = "SELECT cat.id as category_id, cat.name as category_name, SUM(oi.quantity * oi.price_at_purchase) as category_revenue
                          FROM order_items oi
                          JOIN products p ON oi.product_id = p.id
...
<form method="GET" action="<?php echo SITE_URL; ?>admin/reports_sales/" class="form-inline mb-4"> <!-- Corrected form action -->
    <div class="form-group me-2">
        <label for="date_from" class="me-1">From:</label>
        <input type="date" class="form-control" id="date_from" name="date_from" value="<?php echo htmlspecialchars($date_from); ?>">
    </div>
    <div class="form-group me-2">
        <label for="date_to" class="me-1">To:</label>
            ...
            <div class="card-body">
                ...
                <table class="table table-sm">
                    ...
                    <?php foreach ($sales_by_product as $prod_sale): ?>
                        <tr>
                            <td><a href="<?php echo SITE_URL; ?>admin/product_edit/?id=<?php echo $prod_sale['product_id']; ?>"><?php echo htmlspecialchars($prod_sale['product_name']); ?></a></td> <!-- Corrected link -->
            ...
            <div class="card-body">
                ...
                <table class="table table-sm">
                    ...
                    <?php foreach ($sales_by_category as $cat_sale): ?>
                        <tr>
                            <td><a href="<?php echo SITE_URL; ?>admin/category_edit/?id=<?php echo $cat_sale['category_id']; ?>"><?php echo htmlspecialchars($cat_sale['category_name']); ?></a></td> <!-- Corrected link -->
...
<!-- Chart.js and its initialization script remain the same -->
