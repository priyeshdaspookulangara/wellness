    ...
    if (empty($errors)) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            $stmt_update->bind_param(
                ...
                $product_data['how_it_works'],
                $product_data['health_benefits_text'],
                $product_data['gauss_strength'],
                $product_data['material_quality_design'],
                $product_data['usage_guide_text'],
                $product_data['price'],
                $product_data['stock'],
                $image_file_name,
