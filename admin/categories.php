...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="category_add.php" class="btn btn-sm btn-outline-primary">
                ...
                <?php foreach ($categories as $category): ?>
                    <tr>
                        ...
                        <td class="action-buttons">
                            <a href="category_edit.php?id=<?php echo $category['id']; ?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                            <a href="category_delete.php?id=<?php echo $category['id']; ?>" class="btn btn-sm btn-danger confirm-delete" title="Delete"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
